...
PHASES=$(node "/Users/chad.cluff/personal/twittercelebrity/.claude/get-shit-done/bin/gsd-tools.cjs" phases list)
...
```bash
node "/Users/chad.cluff/personal/twittercelebrity/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs(roadmap): add gap closure phases {N}-{M}" --files .planning/ROADMAP.md .planning/REQUIREMENTS.md
```
